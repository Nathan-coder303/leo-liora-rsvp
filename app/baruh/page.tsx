...
const MSG_KEY   = "leo-liora-baruh-message";
const DEFAULT_MSG =
...
export default function BaruhPage() {
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const mine = (data.guests as Guest[])
  ...
  return (
    <div className={serif.className} style={{ minHeight:"100vh", backgroundColor:BLACK, color:GOLD, padding:"2rem 1rem" }}>
      ...
      <div style={{ maxWidth:900, margin:"0 auto 1.25rem" }}>
        ...
        <p style={{ color:GOLD_DIM, fontSize:"0.75rem", letterSpacing:"0.1em", fontVariant:"small-caps" }}>Baruh&apos;s Guests · compose &amp; send</p>
