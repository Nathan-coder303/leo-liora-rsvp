...
const DEFAULT_REMINDERS = [
  ...
  `Hi {name} — 2 days! 💍✨\n\nThat's 48 hours. 2,880 minutes. Not that anyone is counting (we are, obviously).\n\nThe rings are ready, the playlist is dangerously long, and Leo has rehearsed the first dance roughly 400 times. Liora has approved about three of them.\n\nThursday, August 13, 2026\n\n🥂 Cocktail Hour | 5:00 PM\n💍 Ceremony to Follow\n\n📍 The Shul of Bal Harbour\n9540 Collins Ave\nSurfside, FL 33154\n\nYour only job: show up, look wonderful (easy for you), and save some energy for the dance floor.\n\nSee you in 2 days!\n\nLeo & Liora ❤️`,
];
